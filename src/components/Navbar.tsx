...
[]);
    ...
    return (
        <nav className={`min-w-90 lg:w-[1000px] md:mt-6 mt-2 mx-auto  p-4 bg-blue-950/30 backdrop-blur-lg rounded-2xl shadow-lg sticky top-6 z-50 border-2 border-gray-700 shadow-blue-500/40 hover:shadow-blue-500/60 active:shadow-blue-500/60 transition-all duration-300 ${isScrolled ? 'scale-90 py-3 -translate-y-4' : 'scale-100 py-3 translate-y-0'}`}>
