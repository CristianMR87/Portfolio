            ...
            {isOpen && (
                ...
                >
                    ...
                    <Button onClick={copyEmail}>
                        <FaCopy size={16} className="text-white hover:text-blue-500 active:text-blue-400 shadow-lg  hover:shadow-blue-400/60 active:shadow-blue-400/60 transition-all duration-300" />
                        {copied && (
                            <span className="absolute -bottom-11 left-6 transform -translate-x-1/2 bg-gray-800 text-white text-xs py-1 px-2 border border-cyan-400/30 rounded-2xl">
                                ¡Email Copiado!
                            </span>
                        )}
                    </Button>
