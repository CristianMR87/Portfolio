...
const ExperienceSection: React.FC = () => {
    return (
        <section className="min-w-100 lg:min-w-240 p-4 mt-14 mx-auto w-3/5">
            <h2 className="text-5xl font-bold text-blue-400 text-center lg:text-center mb-8">Experiencia</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Experiencia 1 */}
                <div className="relative bg-gradient-to-br from-gray-900 to-gray-800 p-6 rounded-xl shadow-lg shadow-blue-500/20 hover:shadow-blue-500/60 transition-all duration-300 border border-gray-700 group">
                ...
                {/* Experiencia 2 */}
                <div className="relative bg-gradient-to-br from-gray-900 to-gray-800 p-6 rounded-xl shadow-lg shadow-green-500/20 hover:shadow-green-500/60 transition-all duration-300 border border-gray-700 group">
