    ...
    return (
        <section className="min-w-95 md:min-w-[768px] lg:min-w-240 p-4 mt-14 mx-auto w-4/5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                {/* Experiencia 1 */}
                <div className="relative min-w-80 bg-gradient-to-br from-gray-900 to-gray-800 p-6 rounded-xl shadow-lg shadow-blue-500/20 hover:shadow-blue-500/60 active:shadow-blue-500/60 transition-all duration-300 border border-gray-700 group">
                ...
                {/* Experiencia 2 */}
                <div className="relative min-w-80 bg-gradient-to-br from-gray-900 to-gray-800 p-6 rounded-xl shadow-lg shadow-green-500/20 hover:shadow-green-500/60 active:shadow-green-500/60 transition-all duration-300 border border-gray-700 group">
